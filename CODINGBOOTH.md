...
- **Console UI** (the Booth console web UI, base variant's default screen) — `index.html` in `web-ttyd-split/`: terminal split view + overlay + proxy toggle (globe) + Markdown shortcut (document icon → web view `http://booth:8765`)
