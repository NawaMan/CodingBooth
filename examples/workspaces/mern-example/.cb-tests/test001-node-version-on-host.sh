...
#
# Smoke test: verify Node.js is installed in the MERN example booth.
#
...
echo "=== Testing Node.js Availability (MERN example) ==="
echo ""

output=$("$BOOTH" --variant base --port "${CB_PORT:-50491}" -- 'node --version' 2>&1) || true
