...
#
# Smoke test: verify Node.js is installed in the Next.js example booth.
#
...
echo "=== Testing Node.js Availability (Next.js example) ==="
echo ""

output=$("$BOOTH" --variant base --port "${CB_PORT:-50501}" -- 'node --version' 2>&1) || true
