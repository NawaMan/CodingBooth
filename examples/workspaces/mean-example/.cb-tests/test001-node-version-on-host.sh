...
#
# Smoke test: verify Node.js is installed in the MEAN example booth.
#
...
echo "=== Testing Node.js Availability (MEAN example) ==="
echo ""

output=$("$BOOTH" --variant base --port "${CB_PORT:-50481}" -- 'node --version' 2>&1) || true
