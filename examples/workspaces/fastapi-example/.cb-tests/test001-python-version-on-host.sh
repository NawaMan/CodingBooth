...
#
# Smoke test: verify Python is installed in the FastAPI example booth.
#
...
echo "=== Testing Python Availability (FastAPI example) ==="
echo ""

output=$("$BOOTH" --variant base --port "${CB_PORT:-50441}" -- 'python --version' 2>&1) || true
