...
#
# Smoke test: verify Python is installed in the Django example booth.
#
...
echo "=== Testing Python Availability (Django example) ==="
echo ""

output=$("$BOOTH" --variant base --port "${CB_PORT:-50431}" -- 'python --version' 2>&1) || true
