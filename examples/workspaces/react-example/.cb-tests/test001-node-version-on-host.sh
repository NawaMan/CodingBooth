...
#
# Smoke test: verify Node.js is installed in the React example booth.
#
...
echo "=== Testing Node.js Availability (React example) ==="
echo ""

output=$("$BOOTH" --variant base --port "${CB_PORT:-50551}" -- 'node --version' 2>&1) || true
