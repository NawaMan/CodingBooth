...
# -----------------------------------------------------------------------------
# Test: Boothfile Redis Installation
#
# Verifies that a Boothfile with `setup redis` correctly installs Redis
...
echo "=== Test: Boothfile Redis Installation ==="
...
if echo "$ACTUAL" | grep -qE "v="; then
    ...
    print_test_result "false" "$0" "1" "redis-server should be installed"
