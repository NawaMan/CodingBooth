...
assert-line "$configfile" "# Generated by: " "booth init new $prj"  "Empty booth creates config.toml"
...
configfile="$prj/.booth/config.toml"
assert-line "$configfile" "# Adjust with : " "booth init adjust --set keep-alive"  "Adjust command has no --select"
