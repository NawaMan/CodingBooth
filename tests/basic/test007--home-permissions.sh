...
# =============================================================================
HOME_USER=$(run_coding_booth --variant base --silence-build -- 'stat -c "%U" /home/coder' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
CODE_EXISTS=$(run_coding_booth --variant base --silence-build -- 'test -d /home/coder/code && echo "OK"' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
BASHRC_CHECK=$(run_coding_booth --variant base --silence-build -- 'test -f /home/coder/.bashrc && stat -c "%U %a" /home/coder/.bashrc' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
PROFILE_CHECK=$(run_coding_booth --variant base --silence-build -- 'test -f /home/coder/.profile && stat -c "%U %a" /home/coder/.profile' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
ZSHRC_CHECK=$(run_coding_booth --variant base --silence-build -- 'test -f /home/coder/.zshrc && stat -c "%U %a" /home/coder/.zshrc' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
GITCONFIG_CHECK=$(run_coding_booth --variant base --silence-build -- 'test -f /home/coder/.gitconfig && stat -c "%U %a" /home/coder/.gitconfig' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
WRITE_TEST=$(run_coding_booth --variant base --silence-build -- 'touch /home/coder/test-write && rm /home/coder/test-write && echo "OK"' | grep -v "codingbooth" 2>&1) || {
...
# =============================================================================
HOME_PERMS=$(run_coding_booth --variant base --silence-build -- 'stat -c "%a" /home/coder' | grep -v "codingbooth" 2>&1) || {
