...
# clang-code-extension--setup.sh
# NOTE: This script has not been tested -- no time (sorry). Please report success or failure. :-p
# Installs the clangd-based VS Code extension (works with both clang and gcc projects)
# plus CMake Tools for project configuration.
set -Eeuo pipefail
